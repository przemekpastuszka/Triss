...
*/
#include "AbstractAliceTableTest.cpp"

class AliceTableComplexQueryTest : public AbstractAliceTableTest {
...
TEST_F(AliceTableComplexQueryTest, shouldReturnFirstRow) {
...
TEST_F(AliceTableComplexQueryTest, shouldReturnFirstTwoRows) {
    q.addConstraint(TypedConstraint<double>::contains(1, 9));
    result = aliceTable -> select(q);
...
TEST_F(AliceTableComplexQueryTest, shouldReturnAnswerForConstraintsOnAllColumns) {
...
TEST_F(AliceTableComplexQueryTest, shouldReturnAllRowsWhenNoConstraintsGiven) {
    result = aliceTable -> select(q);
